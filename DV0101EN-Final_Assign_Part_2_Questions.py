...
data = pd.read_csv(CSV_URL_ADDRESS)
...
app.layout = html.Div([
    ...
    html.Div(id='output-container', className='chart-grid', style={'height':'300px'})
])
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        fig = px.line(yearly_rec, x='Year', y='Automobile_Sales', title="Average Automobile Sales fluctuation over Recession Period")
